...
import com.yhslib.android.config.MApplication;

public abstract class BaseActivityCopy extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            doBusiness(BaseActivityCopy.this);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
